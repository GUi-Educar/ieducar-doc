...
image:img/user-docs/user-figura-15-tipos-ocorrencias-disciplinares.png[Formulário
...
image:img/user-docs/user-figura-16-tipos-transferencia.png[Formulário
...
image:img/user-docs/user-figura-17-cadastro-desistencia.png[Formulário
...
image:img/user-docs/user-figura-18-documentos-padroes.png[Formulário
...
image:img/user-docs/user-figura-19-curso-cadastrado.png[Lista de
...
image:img/user-docs/user-figura-20-detalhes-escola-cadastrada.png[Lista
...
|===
|Componente |Descrição |Como funciona?
|image:img/user-docs/user-componente-iniciar-ano-letivo.png[Botão
iniciar ano letivo] |Iniciar ano letivo |Ao pressionar este botão, o ano
letivo da escola será iniciado.

|image:img/user-docs/user-componente-editar-ano-letivo.png[Botão
...
|image:img/user-docs/user-componente-finalizar-ano-letivo.png[Botão
...
|image:img/user-docs/user-componente-reabrir-ano-letivo.png[Botão
...
image:img/user-docs/user-figura-21-parcial-cadastro-aluno.png[Lista
...
image:img/user-docs/user-figura-22-cadastro-rapido-aluno.png[Formulário
...
image:img/user-docs/user-figura-23-pai-mae-rapido.png[Formulário para
...
image:img/user-docs/user-figura-24-edicao-foto-aluno-pessoa-fisica.png[Formulário
...
image:img/user-docs/user-figura-25-unificando-aluno-duplicado.png[Formulário
...
image:img/user-docs/user-figura-26-editar-disciplina-componente-curricular.png[Formulário
...
image:img/user-docs/user-figura-27-editando-ano-escolar-cadastro-series.png[Formulário
...
image:img/user-docs/user-figura-28-editar-anos-escolas-disciplina-matematica.png[Formulário
...
image:img/user-docs/user-figura-29-editar-ano-escolar-series-escola.png[Formulário
...
image:img/user-docs/user-figura-30-editar-dados-comodo.png[Formulário
...
image:img/user-docs/user-figura-31-editar-cadastro-turmas.png[Formulário
...
image:img/user-docs/user-figura-32-reordenando-alunos-turma.png[Formulário
